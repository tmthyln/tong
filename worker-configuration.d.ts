/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: b273756fac3df74be1a92e92c689c17d)
// Runtime types generated with workerd@1.20260317.1 2025-09-27 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./server/index");
		durableNamespaces: "Lexicon" | "UmapContainer" | "TranslationAgent";
	}
	interface Env {
		DOCUMENTS: R2Bucket;
		DB: D1Database;
		CHUNK_VECTORS: VectorizeIndex;
		AI: Ai;
		LEXICON: DurableObjectNamespace<import("./server/index").Lexicon>;
		UMAP_CONTAINER: DurableObjectNamespace<import("./server/index").UmapContainer>;
		TRANSLATION_AGENT: DurableObjectNamespace<import("./server/index").TranslationAgent>;
		INGEST_DOCUMENT_WORKFLOW: Workflow<Parameters<import("./server/index").IngestDocumentWorkflow['run']>[0]['payload']>;
		REFRESH_CEDICT_WORKFLOW: Workflow<Parameters<import("./server/index").RefreshCedictWorkflow['run']>[0]['payload']>;
		REFRESH_CHAR_IDS_WORKFLOW: Workflow<Parameters<import("./server/index").RefreshCharIdsWorkflow['run']>[0]['payload']>;
	}
}
